...
<!--                </el-tab-pane>-->
                <el-tab-pane v-if="list.receiptHeader && list.receiptHeader.length > 0" label="会议回执" name="sixth">
                  ...
                  <el-button size="small" type="primary" style="float: right; margin: 20px" @click="handleLog" :disabled="readonly">回复</el-button>
                </el-tab-pane>
              </el-tabs>
            </el-form>
          </div>
...
<script>
  ...
  // import {getMeeting, noticeCentreAttend, meetingAttend, getMeetingList, getMeetingReceipt, saveMeetingReceipt} from '@/api/pc'
  import {getMeeting, noticeCentreAttend, getMeetingList, getMeetingReceipt, saveMeetingReceipt} from '@/api/pc'
    ...
    data() {
      return {
        ...
        content : {
          sort: '2',
          name: '活力党建',
          url: '/pc/vitalityParty',
          title: '组织生活',
          path: '/pc/vitalityParty/organization',
          topic: ''
        },
        receiptList: [],
        readonly: false
