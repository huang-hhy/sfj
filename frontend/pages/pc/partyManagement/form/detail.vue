      ...
      <div class="main">
        ...
        <div class="participants">
          ...
          <div v-for="(item, index) in list.participants" :key="index">
            ...
            <el-radio-group v-model="item.result" :disabled="list.disabled">
              <el-radio label="0">优秀</el-radio>
              <el-radio label="1">合格</el-radio>
              <el-radio label="2">不合格</el-radio>
            </el-radio-group>
            <el-input type="textarea" v-if="item.result * 1 === 2" :readonly="list.disabled" v-model="item.reason" placeholder="请填写不合格的理由" />
          </div>
        </div>
        <div class="msg">
    ...
    watch: {
      value: {
        handler(val) {
          ...
          Vue.set(this.list, 'commentatorId', this.$store.state.user.id)
