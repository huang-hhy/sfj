...
export const checkWhiteList = (arr, url) => {
  let res = false
  for (var i in arr) {
    if(arr.indexOf(url) > -1 || url.indexOf('api/home/index/channels/') > -1 || url.indexOf('api/home/index/article/') > -1) {
      res = true
    }
  }
  return res
...
export const splitArr =(array, size) => {
  //处理成len个一组的数据
  var result = [];
