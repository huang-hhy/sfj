  ...
  >
    <el-form ref="OrgLifeForm" :model="formData" :rules="rules" label-width="140px">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="活动地点" prop="address">
            <el-input v-model="formData.address" placeholder="请输入活动地点" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="活动时长(分钟)" prop="times">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="活动类型" prop="meetingTypeId">
            <el-select v-model="formData.meetingTypeId" placeholder="请选择活动类型">
              <el-option
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="活动主题" prop="topics">
            <el-input v-model="formData.topics" type="textarea" rows="2" placeholder="请输入活动主题" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        conveneTime: { required: true, message: '请选择活动时间', trigger: 'blur' },
        times: { required: true, message: '请输入活动时长', trigger: 'blur' },
        meetingTypeId: { required: true, message: '请选择活动类型', trigger: 'blur' },
        participants: { required: true, message: '请选择参与人员', trigger: 'blur' }
      },
