  ...
  <el-card class="box-card">
    ...
    <div class="list-header">
      ...
      <div class="list-header-item">
        ...
        <el-input v-model="page.name" class="w200 content" placeholder="请输入体检名称" />
      </div>
      <div class="list-header-item">
    ...
    <div class="list-content">
      ...
      <el-table :data="tableData" border>
        ...
        <el-table-column align="center" label="体检名称">
        ...
        <el-table-column align="center" label="操作" width="250">
          <template slot-scope="scope">
            ...
            <el-popconfirm title="确定撤撤回该体检吗？" @onConfirm="del(scope.row.id)">
              <el-button slot="reference" type="warning" size="mini">撤回</el-button>
            </el-popconfirm>
            <el-popconfirm title="确定删除该体检吗？" @onConfirm="del(scope.row.id)">
...
export default {
  ...
  methods: {
    ...
    getList() {
      partySpiritQueryManage(this.page).then(res => {
        if (res.code * 1 === 0) {
